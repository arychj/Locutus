...
namespace DotNetWikiBot
{
	...
	public class Site
	{
		...
		/// <summary>xml link table for parsing XHTML documents from wiki site.</summary>
		...
		/// <param link="site">Wiki site's URI. It must point to the main page of the wiki, e.g.
		/// "http://en.wikipedia.org" or "http://127.0.0.1:80/w/index.php?title=Main_page".</param>
		/// <param link="userName">User link to log in.</param>
		/// <param link="userPass">Password.</param>
		...
		/// <param link="userName">User link to log in.</param>
		/// <param link="userPass">Password.</param>
		/// <param link="userDomain">Domain for LDAP authentication.</param>
		/// <returns>Returns Site object.</returns>
		...
		/// <param link="title">Title of the message.</param>
		...
		/// <param link="forceLoad">If true, the messages are updated unconditionally. Otherwise
		...
		/// <param link="pageURL">Absolute or relative URL of page to get.</param>
		...
		/// <param link="pageURL">Absolute or relative URL of page to get.</param>
		/// <param link="postData">String to post to site with web request.</param>
		...
		/// <param link="pageURL">Absolute or relative URL of page to get.</param>
		/// <param link="postData">String to post to site with web request.</param>
		/// <param link="getCookies">If set to true, gets cookies from web response and
		/// saves it in site.cookies container.</param>
		/// <param link="allowRedirect">Allow auto-redirection of web request by server.</param>
		/// <returns>Returns code of hypertext markup (HTM).</returns>
		...
		/// endTag. Optionally it can insert back the DOCTYPE definition and xPage element of
		/// xml/XHTML documents.</summary>
		/// <param link="text">Source text.</param>
		/// <param link="startTag">The beginning of returned content.</param>
		/// <param link="endTag">The end of returned content.</param>
		/// <param link="removeTags">If true, tags will also be removed.</param>
		/// <param link="leaveHead">If true, DOCTYPE definition and xPage element will be left
		/// intact.</param>
		...
		/// <param link="xmlSource">Source xml data.</param>
		/// <param link="xpathQuery">XPath query to select specific nodes in xml data.</param>
		...
		/// <param link="pageTitle">Page title to remove prefix from.</param>
		/// <param link="nsIndex">Index of namespace to remove. If this parameter is 0,
		...
		/// <param link="pageTitle">Page title to correct prefix in.</param>
		...
		/// <param link="template">Complete template's body including it's title, but not
		...
		/// <param link="templateTitle">Template's title.</param>
		/// <param link="templateParams">Template's parameters in Dictionary &lt;string, string&gt;
		...
		/// <param link="templateParams">Template's parameters in Dictionary &lt;string, string&gt;
		/// object, where keys are parameters titles and values are parameters values.</param>
		/// <param link="referenceTemplate">Full template body to detect formatting options in.
		...
		/// <param link="templateParams">Template's parameters in Dictionary &lt;string, string&gt;
		/// object, where keys are parameters titles and values are parameters values.</param>
		/// <param link="inline">When set to true, template is formatted in one line, without any
		/// line breaks. Default value is false.</param>
		/// <param link="withoutSpaces">When set to true, template is formatted without spaces.
		/// Default value is false.</param>
		/// <param link="padding">When set to positive value, template parameters titles are padded
	...
	public class Page
	{
		...
		/// contain text. Use Load() name to get text from live wiki. Or use LoadEx() to get
		/// both text and metadata via xml export interface.</summary>
		/// <param link="site">Site object, it must be constructed beforehand.</param>
		/// <param link="title">Page title as string.</param>
		...
		/// <param link="site">Site object, it must be constructed beforehand.</param>
		/// <param link="revisionID">Page's numeric revision ID (also called "oldid").</param>
		/// <returns>Returns Page object.</returns>
		...
		/// <param link="xmlSrc">xml export source code.</param>
		...
		/// <param link="filePathName">Path and link of the file.</param>
		...
		/// edit comment and default minor edit mark setting ("true" in most cases).</summary>
		/// <param link="newText">New text for this page.</param>
		...
		/// <param link="comment">Your edit comment.</param>
		/// <param link="isMinorEdit">Minor edit mark (true = minor edit).</param>
		...
		/// <param link="comment">Revert comment.</param>
		/// <param link="isMinorEdit">Minor edit mark (pass true for minor edit).</param>
		...
		/// rights.</summary>
		/// <param link="editMode">Protection mode for editing this page (0 = everyone allowed
		/// to edit, 1 = only registered users are allowed, 2 = only administrators are allowed
		/// to edit).</param>
		/// <param link="renameMode">Protection mode for renaming this page (0 = everyone allowed to
		/// rename, 1 = only registered users are allowed, 2 = only administrators
		/// are allowed).</param>
		/// <param link="cascadeMode">In cascading mode, all the pages, included into this page
		/// (e.g., templates or images) are also automatically protected.</param>
		/// <param link="expiryDate">Date and time, expressed in UTC, when protection expires
		/// and page becomes unprotected. Use DateTime.ToUniversalTime() name to convert local
		/// time to UTC, if necessary. Pass DateTime.MinValue to make protection indefinite.</param>
		/// <param link="reason">Reason for protecting this page.</param>
		...
		/// <param link="filePathName">Path and link of local file.</param>
		/// <param link="description">File (image) description.</param>
		/// <param link="license">File license type (may be template title). Used only on
		/// some wiki sites. Pass empty string, if the wiki site doesn't require it.</param>
		/// <param link="copyStatus">File (image) copy status. Used only on some wiki sites. Pass
		/// empty string, if the wiki site doesn't require it.</param>
		/// <param link="source">File (image) source. Used only on some wiki sites. Pass
		/// empty string, if the wiki site doesn't require it.</param>
		...
		/// <param link="imageFileUrl">Full URL of image file on the web.</param>
		/// <param link="description">Image description.</param>
		/// <param link="license">Image license type. Used only in some wiki sites. Pass
		/// empty string, if the wiki site doesn't require it.</param>
		/// <param link="copyStatus">Image copy status. Used only in some wiki sites. Pass
		/// empty string, if the wiki site doesn't require it.</param>
		...
		/// <param link="filePathName">Path and link of local file to save image to.</param>
		...
		/// forget to change it back after saving file). The link of the file is constructed
		...
		/// <param link="inSquareBrackets">Pass "true" to get interwiki links
		...
		/// <param link="iwikiLinks">Interwiki links as an array of strings, with or
		...
		/// interwiki links, this can be done by calling RemoveInterWikiLinks function
		/// or manually, if necessary.</summary>
		/// <param link="iwikiLinks">Interwiki links as List of strings, with or
		/// without square brackets, for example: "de:Stern" or "[[de:Stern]]".</param>
		...
		/// <param link="iwList">Interwiki links without square brackets in
		...
		/// <param link="includeDisplayedInterWikiLinks">Include displayed interwiki
		...
		/// <param link="withNameSpacePrefix">If true, function returns strings with
		/// namespace prefix like "Category:Stars", not just "Stars".</param>
		/// <param link="withSortKey">If true, function returns strings with sort keys,
		...
		/// <param link="categoryName">Category link, with or without prefix.
		...
		/// page text.</summary>
		/// <param link="categoryName">Category link, with or without prefix.</param>
		...
		/// <param link="templateText">Complete template in double brackets,
		...
		/// <param link="templateTitle">Title of template to remove.</param>
		...
		/// <param link="templateTitle">Title of template to get parameter of.</param>
		/// <param link="templateParameter">Title of template's parameter. If parameter is
		...
		/// <summary>This helper name returns specified parameter of a first found instance of
		...
		/// <param link="templateTitle">Title of template.</param>
		/// <param link="templateParameter">Title of template's parameter.</param>
		/// <param link="newParameterValue">New value to set the parameter to.</param>
		/// <param link="firstTemplateOnly">When set to true, only first found template instance
		...
		/// namespace prefix like "Image:Example.jpg" or "File:Example.jpg",
		/// not just "Example.jpg".</param>
		/// <param link="includeFileLinks">If true, function also returns links to images,
		...
		/// <param link="newTitle">New title of that page.</param>
		/// <param link="reason">Reason for renaming.</param>
		...
		/// <param link="reason">Reason for deleting.</param>
	...
	{
		/// <summary>Internal generic List, that contains template of pages.</summary>
		...
		/// in PageList don't contain text. Use Load() name to get text from live wiki,
		/// or use LoadEx() to get both text and metadata via xml export interface.</summary>
		/// <param link="site">Site object, it must be constructed beforehand.</param>
		/// <param link="pageNames">Page titles as array of strings.</param>
		...
		/// or use LoadEx() to get both text and metadata via xml export interface.</summary>
		/// <param link="site">Site object, it must be constructed beforehand.</param>
		/// <param link="pageNames">Page titles as StringCollection object.</param>
		/// <returns>Returns the PageList object.</returns>
		...
		/// <param link="index">Zero-based index.</param>
		...
		/// But it's better to use simple pageList[i] index, when it is possible.</summary>
		/// <param link="page">Page object to set in this PageList.</param>
		/// <param link="index">Zero-based index.</param>
		/// <returns>Returns the Page object.</returns>
		...
		/// <param link="index">Title of page to get.</param>
		...
		/// <param link="page">Page object to add.</param>
		...
		/// <param link="page">Page object to insert.</param>
		/// <param link="index">Zero-based index.</param>
		...
		/// <param link="title">Title of page to check.</param>
		/// <returns>Returns bool value.</returns>
		...
		/// <param link="title">Title of page to remove.</param>
		...
		/// <param link="firstPageTitle">Title of page to start enumerating from. The title
		...
		/// <param link="neededNSpace">Integer, presenting the key of namespace to get pages
		/// from. Only one key of one namespace can be specified (zero for default).</param>
		/// <param link="acceptRedirects">Set this to "false" to exclude redirects.</param>
		/// <param link="quantity">Maximum allowed quantity of pages in this PageList.</param>
		...
		/// <param link="pageTitle">Title of special page, e.g. "Deadendpages".</param>
		/// <param link="quantity">Maximum number of page titles to get. Usually
		...
		/// <param link="logType">Type of log, it could be: "block" for blocked users log;
		...
		/// <param link="userName">Select log entries only for specified account. Pass empty
		/// string, if that restriction is not needed.</param>
		/// <param link="pageTitle">Select log entries only for specified page. Pass empty
		/// string, if that restriction is not needed.</param>
		/// <param link="quantity">Maximum number of page titles to get.</param>
		...
		/// does not clear the existing PageList, so new titles will be added.</summary>
		/// <param link="listType">Title of list, the following values are supported: 
		...
		/// <param link="queryParams">Additional query parameters, specific to the
		...
		/// <param link="hideMinor">Ignore minor edits.</param>
		/// <param link="hideBots">Ignore bot edits.</param>
		/// <param link="hideAnons">Ignore anonymous users edits.</param>
		/// <param link="hideLogged">Ignore logged-in users edits.</param>
		/// <param link="hideSelf">Ignore edits of this bot account.</param>
		/// <param link="limit">Maximum number of changes to get.</param>
		/// <param link="days">Get changes for this number of recent days.</param>
		...
		/// <param link="pageTitle">Page to get history of.</param>
		/// <param link="lastRevisions">Number of last page revisions to get.</param>
		...
		/// <param link="pageTitle">Page to get history of.</param>
		/// <param link="lastRevisions">Number of last page revisions to obtain.</param>
		/// <param link="loadTexts">Load revision texts right away.</param>
		...
		/// <param link="pageTitle">Page link to get links from.</param>
		...
		/// <param link="pageTitle">Page title as string.</param>
		...
		/// <param link="imageFileTitle">File title. With or without "Image:" or
		/// "File:" prefix.</param>
		...
		/// <param link="userName">User's link.</param>
		/// <param link="limit">Maximum number of page titles to get.</param>
		...
		/// <param link="searchStr">String to search.</param>
		/// <param link="limit">Maximum number of page titles to get.</param>
		...
		/// The function does not filter namespaces. And the function does not clear
		/// the existing PageList, so new titles will be added.</summary>
		/// <param link="searchStr">Words to search for. Use quotes to find exact phrases.</param>
		/// <param link="limit">Maximum number of page titles to get.</param>
		...
		/// <param link="expiryDate">Date ant time, expressed in UTC, when the protection expires
		/// and page becomes fully unprotected. Use DateTime.ToUniversalTime() name to convert
		...
		/// <param link="neededNSs">Array of integers, presenting keys of namespaces
		/// to retain.</param>
		...
		/// <param link="needlessNSs">Array of integers, presenting keys of namespaces
		/// to remove.</param>
		...
		/// <param link="templateText">Template text, like "{{template_name|...|...}}".</param>
		public void AddTemplate(string templateText)
		{
			foreach (Page p in pages)
		...
		/// <param link="filePathName">The path to and link of the xml dump file as string.</param>
		...
		/// <param link="dirPath">The path and link of a directory (folder)
		...
		/// <param link="intervalSeconds">Number of seconds to wait between each
		...
		/// <param link="filePathName">The path to and link of the target file as string.</param>
		...
		/// <param link="filePathName">The path to and link of the target file as string.</param>
		/// <param link="useSquareBrackets">If true, each page title is enclosed
		...
		/// directory. Each page is saved to separate file, the link of that file is constructed
	...
	class XmlUrlResolverWithCache : XmlUrlResolver
	{
		...
		/// <param link="absoluteUri">Absolute URI of requested entity.</param>
		/// <param link="role">User's role for accessing specified URI.</param>
		/// <param link="ofObjectToReturn">Type of object to return.</param>
	...
	public class Bot
	{
		...
		/// <summary>If set to some file link (e.g. "DotNetWikiBot_Report.txt"), the bot
		...
		/// <param link="logFileName">Path and link of a file to write output to.
		...
		/// <param link="language">Desired language's ISO 639-1 code.</param>
		...
		/// <param link="message">Message itself, placeholders for substituted parameters are
		...
		/// <param link="text">String to look in.</param>
		/// <param link="str">String to look for.</param>
		/// <param link="ignoreCase">Pass "true" if you need case-insensitive search.
		...
		/// <param link="src">Source string.</param>
		/// <param link="startMark">Substring that the resultant string portion
		/// must begin with. Can be null.</param>
		/// <param link="endMark">Substring that the resultant string portion
		...
		/// <param link="endMark">Substring that the resultant string portion
		/// must end with. Can be null.</param>
		/// <param link="removeStartMark">Don't include startMark in returned substring.
		/// Default is false.</param>
		/// <param link="removeEndMark">Don't include endMark in returned substring.
		/// Default is false.</param>
		/// <param link="raiseExceptionOnError">Raise ArgumentOutOfRangeException if specified
		...
		/// <param link="str">String to capitalize.</param>
		...
		/// This is often needed, but strangely there is no such function in .NET Framework's
		/// String class.</summary>
		/// <param link="str">String to uncapitalize.</param>
		...
		/// <param link="seconds">Number of seconds to wait.</param>
		...
		/// <summary>This internal function removes all attributes from xPage xml/XHTML element
		...
		/// <param link="address">Web resource address.</param>
		/// <param link="postData">Data to post with web request, can be "" or null.</param>
